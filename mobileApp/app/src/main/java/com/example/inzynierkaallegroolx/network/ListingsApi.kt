...
data class ListingCreateBody(val title: String, val description: String, val price: String, val platform: String)
data class ListingUpdateBody(val title: String? = null, val description: String? = null, val price: String? = null)
